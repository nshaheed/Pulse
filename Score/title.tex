...
\newcommand*{\plogo}{\fbox{2015}} % Generic publisher logo
...
{\fontsize{90}{115}\selectfont Pulse}\\[\baselineskip] % Main title which draws the focus of the reader

{\Large For Solo Flute, Computer, and Heart-Rate Monitor}\par % Tagline or further description
